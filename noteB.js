...
// const $how = SCRIPTS.map((x) => [x.direction, x.link]);
// console.log($how);
...
// console.log(
//   SCRIPTS.reduce((a, b) => {
//     return charCpunt(a) < charCpunt(b) ? a : b;
//   })
// );

// how to do avrage of things in array
// /**
//  *
//  * @param {[]} arr
//  * @returns {number}
...
// console.log(
//   Math.round(avg(SCRIPTS.filter((s) => s.living).map((s) => s.year)))
// );
...
console.log(countBy([1, 2, 3, 4, 5], (code) => n > 2));
